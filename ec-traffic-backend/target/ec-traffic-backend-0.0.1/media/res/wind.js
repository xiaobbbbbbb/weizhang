...
*/
(function(win) {
	var root = win.GV.HOST+win.GV.JS_ROOT || location.origin + '/media/', //在wind.js加载之前定义GV.JS_ROOT
		ver = '',
		//定义常用JS组件别名，使用别名加载
		alias = {
            datePicker         : 'bootstrap/datepicker/js/bootstrap-datetimepicker',
            //jquery util plugs
            ajaxForm          : 'res/ajaxForm',
            toJSON            : 'res/jquery.json-2.3.min',
		...
		alias_css = {
			...
			datePicker	: 'bootstrap/datepicker/css/bootstrap-datetimepicker.min'
		};
