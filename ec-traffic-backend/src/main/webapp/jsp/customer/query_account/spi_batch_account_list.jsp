...
<body class="J_scroll_fixed">
	<div class="wrap_pop">
		<div class="nav">
			<ul>
				<li class="current"><a href=" ${ctx}/queryAccount/spiBatchAccount/">批次查询对账</a></li>
			</ul>
		</div>
						...
						<td align="left" valign="top">
							...
							<table>
								<tr>
									...
									<td><input id="beginCreateTime" class="input length_2 J_date" type="text" name="beginCreateTime" value="${param.beginCreateTime}" /> ~ <input id="endCreateTime"
										type="text" class="input length_2 J_date" name="endCreateTime" value="${param.endCreateTime}" /></td>
								</tr>
							</table>
						</td>
