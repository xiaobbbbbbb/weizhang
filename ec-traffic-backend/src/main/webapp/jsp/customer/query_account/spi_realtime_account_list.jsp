						...
						<td align="left" valign="top">
							...
							<table>
								<tr>
									...
									<td><input id="beginCreateTime" class="input length_2 J_date" type="text" name="beginCreateTime" value="${param.beginCreateTime}" /> ~ <input
										id="endCreateTime" type="text" class="input length_2 J_date" name="endCreateTime" value="${param.endCreateTime}" /></td>
								</tr>
							</table>
						</td>
