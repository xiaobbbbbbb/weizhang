...
<body class="J_scroll_fixed">
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="${ctx}/car/index">车辆管理</a></li>
			<li><a href="${ctx}/car/saveUpdateUI">添加</a></li>
		</ul>
	</div>
	<div class="common-form">
		<form class="well form-inline" action="${ctx}/car/" method="post">
						...
						<tr>
							<td align="center">
								<div
									...
									<a href="${ctx}/car/saveUpdateUI?id=${dto.id}" class="green">
										<i class="icon-pencil bigger-130"></i>
									</a> <a href="${ctx}/car/delete?ids=${dto.id}"
										class="red J_ajax_del"> <i class="icon-trash bigger-130"></i>
									</a>
								</div>
							</td>
							<td>${sn.count}</td>
							...
							<td align="center"><fmt:formatDate value="${dto.createTime}"
