...
public class TInputRule extends AbstractTable {
	...
	private TInputRule(){
		super.tableName = "input_rule";
	}

	private TInputRule(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TInputRule getInstance() {
		return new TInputRule();
	}

	public static final TInputRule getInstance(String aliasName) {
		return new TInputRule(aliasName);
	}
	...
	*/
	...
	private final TableField<?>[] allFields = new TableField<?>[] {id,provinceId,provinceName,provincePinyin,provincePrefix,cityId,cityPinyin,cityName,carNoPrefix,carFrameLen,carEngineLen,ownerNameLen,carCertificateLen,updateTime,createTime};
	...
	public String toString() {
		return "TInputRule[table=input_rule]";
	}
