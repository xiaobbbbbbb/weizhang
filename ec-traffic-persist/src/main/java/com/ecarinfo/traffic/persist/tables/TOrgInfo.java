...
<<<<<<< .mine
	private final TableField<?>[] allFields = new TableField<?>[] {id,code,name,address,contacts,tel,appKey,expiredTime,status,joinTime,queryType,maxCarCounts,leftCarCounts,maxQueryCounts,leftQueryCounts,provinceId,cityId,salesman,tackId,belongTo,carFrameLen,carEngineLen,ownerNameLen,carCertificateLen,isDelete,updateTime,createTime};
=======
