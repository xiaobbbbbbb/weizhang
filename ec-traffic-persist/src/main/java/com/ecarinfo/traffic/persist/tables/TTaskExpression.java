...
public class TTaskExpression extends AbstractTable {

	static {
		init();
	}

	private TTaskExpression(){
		super.tableName = "task_expression";
	}

	private TTaskExpression(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TTaskExpression getInstance() {
		return new TTaskExpression();
	}

	public static final TTaskExpression getInstance(String aliasName) {
		return new TTaskExpression(aliasName);
	}
	...
	*/
	 ...
	 *表达式名称 | varchar(255)
	*/
	public final TableField<String> name = new TableFieldImpl<String>(this,"name","name","表达式名称");
	...
	*/
	...
	public String toString() {
		return "TTaskExpression[table=task_expression]";
	}
